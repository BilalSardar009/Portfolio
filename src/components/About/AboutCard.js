      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            from <span className="purple"> Cambridge, United Kingdom.</span>
            <br />I am currently pursuing my Master's degree in Artificial Intelligence at Anglia Ruskin University, Cambridge.
            <br />
